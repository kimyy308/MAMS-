...
%         vert_param
    ...
    case 'nwp_1_10_auto'
%         vert_param
        grd_file=['/home/auto/MAMS/Data/01_NWP_1_10/Input/',testname,'_grid.nc'];
        scoord = [10.0 1.0 250.0 40] % theta_s theta_b hc N
        Vtransform = 2;
        Vstretching = 4;
        disp(' ')
    ...
    case 'auto02'
%         vert_param
        grd_file=['/data1/auto/input/roms_grd.nc'];
        scoord = [5.0 0.4 4.0 20] % theta_s theta_b hc N
        Vtransform = 1;
        Vstretching = 1;
        disp(' ')
        disp([ 'Loading ROMS grd for application: ' location])
...
%         grd_file ='E:\Data\Model\ROMS\nwp_1_20\input\test38\roms_grid_nwp_1_20_test38.nc' ;
    ...
    case 'NWP_1_20_linux'
%         vert_param
        grd_file =['/home/kimyy/Model/ROMS/nwp_1_20/input/',testname,'/spinup/roms_grid_nwp_1_20_',testname,'.nc'] ;
        scoord = [10.0 1.0 250.0 40] % theta_s theta_b hc N
        Vtransform = 2;
        Vstretching = 4;
        disp(' ')
