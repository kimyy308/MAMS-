...
MAMS=$2
OISSTdir=$MAMS/Data/OISST
obs_EnOIdir=${MAMS}/Data/DA/01_NWP_1_10/OISST
echo $OISSTdir
...
%    filename = [filepath,'/','${fulldate}120000-NCEI-L4_GHRSST-SSTblend-AVHRR_OI-GLOB-v02.0-fv02.0.nc'];
    filename = [filepath,'/','OISST_${fulldate}.nc'];
...
%     end
    ...
    outname = strcat('${OISSTdir}/${fulldate}/','${testname}_obs_${fulldate}.nc')
...
ln -sf ${OISSTdir}/${fulldate}/${testname}_obs_${fulldate}.nc ${obs_EnOIdir}/${testname}_obs.nc
