...
% % Updated 18-Feb-2019 by Y.Y.Kim
...
for yind=1:length(year)
    ...
    if (strcmp(system_name,'PCWIN64'))
        bryname = ['E:\Data\Model\ROMS\nwp_1_10\input\test38\','roms_bndy_',casename,'_SODA_3_4_2_',num2str(yyyy), '_',testname,'.nc'];
    elseif (strcmp(system_name,'GLNXA64'))
        bryname = ['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/',model_name,'/roms_bndy_',casename,'_',model_name,'_',num2str(yyyy), '_',testname,'.nc'];
    end
    ...
    for mi = mm(1):mm(end);
        ...
        elseif (strcmp(system_name,'GLNXA64'))
            filename = ['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/',model_name,'/',testname,'/',model_name,'_Y', num2str(yyyy,4), 'M', num2str(mi), '_',testname,'.nc'];
        end
            nc = netcdf(filename);
