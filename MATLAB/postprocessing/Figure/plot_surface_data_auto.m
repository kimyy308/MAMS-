    ...
    %                 num2str(temphour,'%02i'), '.nc');  ~ test37
        ...
        %         titlename = strcat(var, ' (',num2str(temphour,'%02i'), ':00-', num2str(day,'%02i'), '-', char(calendarname(month)), '-', num2str(year),')');
                ...
                clabel(C,h2,'FontSize',m_contour_label_fontsize,'Color',m_contour_label_color, ...
                    'Rotation',m_contour_rotation,'fontweight',m_contour_fontweight);
...
% %                 title(h,colorbar_title,'fontsize',colorbar_title_fontsize, 'position', [300, -0.1, 0]);
% %                 caxis(shadlev);
    ...
    %         print(fig,jpgname,'-djpg');
            ...
            figdir=[MAMS,'/Figure/01_NWP_1_10', '/', num2str(fyear,'%04i'), '/', num2str(fmonth,'%02i'), '/', num2str(fyear,'%04i'), num2str(fmonth,'%02i'), num2str(fday, '%02i'), '/NWP'];
