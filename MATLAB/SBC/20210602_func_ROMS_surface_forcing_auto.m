...
% % 1. current dir name
% 
%     dir_hname = '/home/auto/MAMS/Data/';
%     dir_tname = [num2str(temp_runtime(1),'%04i'),num2str(temp_runtime(2),'%02i'), ...
%             num2str(temp_runtime(3), '%02i')];
% 
%     UM_root_dir = [dir_hname 'UM_global_10km/', dir_tname, '/nc_pieces/'];
%     NOMADS_root_dir = [dir_hname 'NOMADS/gfs_0p25/', dir_tname, '/nc_pieces/'];
%     
%     %======================================================================
%     % check if nc files exist or not
%     % check folder, then check nc files
%     %======================================================================
%     
%     listing = dir(UM_root_dir);
%     if (exist(UM_root_dir, 'dir')==7)
%         if isempty(listing)
%             disp(['ERROR! there is no nc file']);
%         else
%             continue
%         end
%     end
%     
%     listing = dir(NOMAD_root_dir);
%     if (exist(NOMAD_root_dir, 'dir')==7)
%         if isempty(listing)
%             disp(['ERROR! there is no nc file']);
%         else
%             continue
...
% 
%     if (exist(UM_root_dir, 'dir')~=7)
%         UM_root_dir = [dir_hname 'UM_global_10km/', dir_tname, '_forecast/nc_pieces/'];
%     end
%     if (exist(NOMADS_root_dir, 'dir')~=7)
%         NOMADS_root_dir = [dir_hname 'NOMADS/gfs_0p25/', dir_tname, '_forecast/nc_pieces/'];
%     end
%==========================================================================
