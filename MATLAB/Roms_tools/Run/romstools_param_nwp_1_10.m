...
%
ROMS_title  = 'NorthwesternPacific Model 1/10';
ROMS_config = 'Northwestern Pacific';
%
%  ROMSTOOLS directory
%
ROMSTOOLS_dir = '..\';
...
if (strcmp(system_name,'PCWIN64'))   % % for windows
    grdname=['E:\Data\Model\ROMS\nwp_1_10\input\test06\roms_grid_nwp_1_10_test06.nc'];
elseif (strcmp(system_name,'GLNXA64'))    % % for linux
    grdname=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_10/input/test06/spinup/roms_grid_nwp_1_10_test06.nc'];
end
smoothname=['E:\Data\Model\ROMS\nwp_1_10\input\test06\roms_grid_nwp_1_10_test06.nc'];
...
clmname=['E:\Data\Model\ROMS\nwp_1_10\input\test06\','roms_nwp_clim.nc'];
% ininame=[ROMS_files_dir,'roms_nwp_ini2_test27.nc'];
ininame=['E:\Data\Model\ROMS\nwp_1_10\input\test06\','roms_nwp_ini_test06.nc'];
rstname=['E:\Data\Model\ROMS\nwp_1_10\test06\run\1980\','ocean_avg_0001.nc'];
oaname =['E:\Data\Model\ROMS\nwp_1_10\input\test06\','roms_nwp_oa.nc'];    % oa file  : intermediate file not used
                                             %            in roms simulations
...
lonmax =  161.98;   % Maximum longitude [degree east]
...
%  in the same format)
%
topofile = ['E:\Data\Topography\Etopo\etopo1.nc'];
%
...
%
if (strcmp(system_name,'PCWIN64'))   % % for windows
    tidename=['E:\Data\Model\ROMS\nwp_1_10\etc\Roms_tools\TPXO7\TPXO7.nc'];
elseif (strcmp(system_name,'GLNXA64'))    % % for linux
...
%===================================================================
%
% frcname=['E:\Data\Model\ROMS\nwp_1_10\input\test06\nwp_1_10_1980_tides.nc'];
frcname=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_10/input/test06/nwp_1_10_1982_tides.nc'];

Yorig         = 1980;               % reference time for vector time
                                    % in roms initial and forcing files
%===================================================================
%
Ymin          = 1982;               % first forcing year
Ymax          = 1982;               % last  forcing year
