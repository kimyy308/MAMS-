...
elseif (strcmp(system_name,'GLNXA64'))
    % % for linux
    outputdir=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_20/input/',testname,'/'];
end
...
year=[1976:2005];  %% if year == 0, make climate data!
...
grdname = ['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_20/input/',testname,'/spinup/roms_grid_nwp_1_20_',testname,'.nc'];
grd_file = grdname ;
...
head=[outputdir,'roms_river_nwp_1_20_'];
mid=num2str(year(i));
foot='.nc';
if (year==0)
