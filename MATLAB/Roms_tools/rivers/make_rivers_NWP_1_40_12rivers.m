...
romstools_param
testname='test01';
outputdir=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/',testname,'/'];
...
year=[1980];  %% if year == 0, make climate data!
...
grdname = ['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/',testname,'/spinup/roms_grid_nwp_1_40_',testname,'.nc'];
...
head=[outputdir,'roms_river_nwp_1_40_'];
mid=num2str(year(i));
foot='.nc';
if (year==0)
