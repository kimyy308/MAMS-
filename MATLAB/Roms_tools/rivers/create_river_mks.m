function create_river_mks(grd,Fname,cycle,grd_file)
disp('  ')
...
if isempty(nc)
  ...
  nc.source   = ncchar('eas_rivers_discharge');
  nc.details  = ncchar('The 2 Rivers are : 1. ChangJiang+Huai, 2. HuangHe.');
...
nc('river') = river;
time_dimension = 'time';
nc(time_dimension) = 'unlimited'; % UNLIMITED
...
nc{theVarname}.units = ncchar('days');
nc{theVarname}.cycle_length = cycle ;
