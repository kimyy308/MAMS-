...
romstools_param
testname='test01';
outputdir=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_50/input/',testname,'/'];
...
grdname = ['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_50/input/',testname,'/spinup/roms_grid_nwp_1_50_',testname,'.nc'];
...
head=[outputdir,'roms_river_nwp_1_50_'];
mid=num2str(year(i));
foot='.nc';
if (year==0)
