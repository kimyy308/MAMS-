...
year=[1981:1990];  %% if year == 0, make climate data!
...
% head='river_yw12_';
% head='roms_';
head='roms_river_nwp_1_10_';
% head='roms_yw36_';
mid=num2str(year(i));
% foot='_river_nwps12N.nc';
% foot='_river_edyz.nc';
% foot='_river_edyz_30l.nc';
% foot='_river_tide_test.nc';
% foot='_river_edyz3sin.nc';
foot='.nc';
if (year==0)
