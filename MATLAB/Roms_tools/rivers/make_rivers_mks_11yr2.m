...
season_cycle=[9650 9257.5 11632.5 21150 32450 41425 ...
	      47300 36925 33025 27000 19350 11215 19350 19350 ];
...
% grd_file ='D:\matlab\roms\input\roms_grd_yellow5m_run.nc';
% grd_file ='D:\matlab\roms\input\roms_grd_yw5_curve.nc';
...
%  file=1993:2002;
file=1992:2002
Fname='roms_river_12degree_new.nc';
...
ncin=netcdf('roms_1993_river_new.nc');
...
% for i= 1:12:120
for i= 1:12:132
    Iname=['roms_',num2str(file(f)),'_river_new.nc']
