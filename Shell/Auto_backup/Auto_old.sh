...
startdate=20190907     #YYYYMMDD
enddate=20190907       #YYYYMMDD 
...
#/bin/sh -xv ${AUTO}/old_Step_001_01_get_NOMADS_for_SBC.sh $fulldate $MAMS > $logdir/old_Step_001_01_get_NOMADS_for_SBC.log 
#/bin/sh -xv ${AUTO}/old_Step_001_02_convert_NOMADS_for_SBC.sh $fulldate $MAMS > $logdir/old_Step_001_02_convert_NOMADS_for_SBC.log 2>&1
#/bin/sh -xv ${AUTO}/Step_001_03_figure_NOMADS_for_check.sh $fulldate $MAMS > $logdir/Step_001_03_figure_NOMADS_for_check.log 2>&1
#/bin/sh -xv ${AUTO}/old_Step_001_04_get_UM_global_for_SBC.sh $fulldate $MAMS > $logdir/old_Step_001_04_get_UM_global_for_SBC.log 
#/bin/sh -xv ${AUTO}/old_Step_001_05_convert_UM_for_SBC.sh $fulldate $MAMS > $logdir/old_Step_001_05_convert_UM_for_SBC.log 2>&1
#/bin/sh -xv ${AUTO}/Step_001_06_figure_UM_for_check.sh $fulldate $MAMS > $logdir/Step_001_06_figure_UM_for_check.log 2>&1
#/bin/sh -xv ${AUTO}/old_Step_002_01_get_MyOcean_for_OBC.sh $fulldate $MAMS > $logdir/old_Step_002_01_get_MyOcean_for_OBC.log 2>&1
#/bin/sh -xv ${AUTO}/old_Step_003_01_get_OISST_for_DA.sh $fulldate $MAMS > $logdir/old_Step_003_01_get_OISST_for_DA.log 2>&1
...
/bin/sh -xv ${AUTO}/old_Step_009_01_make_ctrlfile_for_NWP.sh $fulldate $MAMS > $logdir/old_Step_009_01_make_ctrlfile_for_NWP.log 2>&1
...
#csh -xv ${AUTO}/Step_011_NWP_postprocess.csh
