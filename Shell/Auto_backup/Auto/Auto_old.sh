...
cd ${AUTO}
ls
source ./Auto_bashrc.sh

startdate=20210709
enddate=20210710  #2 days ago from now
run_idx=`echo $enddate - $startdate | bc`

tempdate=$startdate
while [ ${run_idx} -ge 0 ]; do # run_idx
fulldate=$tempdate
...
#/bin/sh -xv ${AUTO}/Step_001_01_get_UM_global_for_SBC.sh $fulldate $MAMS > $logdir/Step_001_01_get_UM_global_for_SBC.log 
#/bin/sh -xv ${AUTO}/Step_001_02_convert_UM_for_SBC.sh $fulldate $MAMS > $logdir/Step_001_02_convert_UM_for_SBC.log 2>&1
##/bin/sh -xv ${AUTO}/Step_001_03_figure_UM_for_check.sh $fulldate $MAMS > $logdir/Step_001_03_figure_UM_for_check.log 2>&1
#/bin/sh -xv ${AUTO}/Step_001_04_get_NOMADS_for_SBC.sh $fulldate $MAMS > $logdir/Step_001_04_get_NOMADS_for_SBC.log 
#/bin/sh -xv ${AUTO}/Step_001_05_convert_NOMADS_for_SBC.sh $fulldate $MAMS > $logdir/Step_001_05_convert_NOMADS_for_SBC.log 2>&1
##/bin/sh -xv ${AUTO}/Step_001_06_figure_NOMADS_for_check.sh $fulldate $MAMS > $logdir/Step_001_06_figure_NOMADS_for_check.log 2>&1
...
#/bin/sh -xv ${AUTO}/Step_003_03_get_OSTIA_for_DA.sh $fulldate $MAMS > $logdir/Step_003_03_get_OSTIA_for_DA.log 2>&1

### Get CJD --> hanging on crontab (every hour)

##csh -xv /data1/auto/src/auto_all.csh
...
#/bin/sh -xv ${AUTO}/Step_013_04_fig_LTRANS.sh $fulldate $MAMS > $logdir/Step_013_04_fig_LTRANS.log 2>&1
...
tempdate=`date -d "$tempdate 1 days" +%Y%m%d`
run_idx=`echo $enddate - $tempdate | bc`
done #run_idx
