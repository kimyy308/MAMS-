...
##    cd ${workdir}${year}
    ...
    indthree=`printf "%03d" $ind`
    	/data1/auto/App/kwgrib2/kwgrib -d ${indthree} tmp2m.gdas.${year}${monthtwo}.grb2 -netcdf ./temp/tmp2m.gdas.${year}${monthtwo}_${indthree}.nc
...
##        ncecat ./pressfc/pressfc.gdas.${year}${monthtwo}* -O ./pressfc.gdas.${year}${monthtwo}.nc
        ncrcat -h ./temp/tmp2m.gdas.${year}${monthtwo}* -O /data1/stlee/ext_hdd/NOMADS/${year}/nc_file/tmp2m.gdas.${year}${monthtwo}.nc
##      ncrcat -h ./temp/wnd10m.gdas.${year}${monthtwo}* -O /data1/stlee/ext_hdd/NOMADS/${year}/nc_file/wnd10m.gdas.${year}${monthtwo}.nc

    rm -f ./temp/tmp2m.gdas.${year}${monthtwo}*
