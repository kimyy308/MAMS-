...
for (( lag_day; lag_day<=lag_max; lag_day++ )) do
  ...
  for (( arridx; arridx<=arridx_max; arridx++ )) do
    ...
    #TMP 1.5m above ground (#39)
    ~/MAMS/App/kwgrib2/kwgrib -d 39 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/tmp_${year2}${month2}${day2}_${houridx}h.nc
    #UGRD 10m above ground (#26)
    ~/MAMS/App/kwgrib2/kwgrib -d 26 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/u10m_${year2}${month2}${day2}_${houridx}h.nc
    #VGRD 10m above ground (#27)
    ~/MAMS/App/kwgrib2/kwgrib -d 27 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/v10m_${year2}${month2}${day2}_${houridx}h.nc
    #PRMSL pressure reduced to MSL (#107)
    ~/MAMS/App/kwgrib2/kwgrib -d 107 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/psl_${year2}${month2}${day2}_${houridx}h.nc
    #RH 1.5 m above ground (#44, Relative Humidity)
    ~/MAMS/App/kwgrib2/kwgrib -d 44 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/rhum_${year2}${month2}${day2}_${houridx}h.nc
    #??? surface (#1, Net Down Surface SW Flux)
    ~/MAMS/App/kwgrib2/kwgrib -d 1 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/swrad_${year2}${month2}${day2}_${houridx}h.nc
    #TPR surface (#72, Total Precipitation Rate)
    ~/MAMS/App/kwgrib2/kwgrib -d 72 ./../${year2}${month2}${day2}_forecast/g120_v070_erea_unis_h${arr_i[${arridx}]}.${year}${month}${day}00.gb2 -netcdf nc_pieces/tprep_${year2}${month2}${day2}_${houridx}h.nc
  done
done
