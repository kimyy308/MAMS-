...
pwd
bin 
mget g100_v070_erea_unis_h000.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h003.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h006.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h009.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h012.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h015.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h018.${year}${month}${day}00.gb2
mget g100_v070_erea_unis_h021.${year}${month}${day}00.gb2
quit
EOF
...
ftp -ni $host <<EOF
        ...
        pwd
        bin 
        mget g100_v070_erea_unis_h${arr_i[0]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[1]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[2]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[3]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[4]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[5]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[6]}.${year_fix}${month_fix}${day_fix}00.gb2
        mget g100_v070_erea_unis_h${arr_i[7]}.${year_fix}${month_fix}${day_fix}00.gb2
        quit
EOF
done
